...
#define COWODA0_SENSORS_TOPIC "COWODA0/sensor/outside/attrib"
#define COWODA0_SWITCH_TOPIC "COWODA0/switch/boilroom/attrib"
String COPUMP_GET_TOPIC = String(COWODA0_SWITCH_TOPIC);   // temperatura outside avg NEWS
String COPumpStatus_json = ("boilroom_pump2CO");
String WaterPumpStatus_json = ("boilroom_pump1Water");
